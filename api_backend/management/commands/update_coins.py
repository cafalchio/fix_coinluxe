...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        for coin in coin_data:
            ...
            market_cap_rank = (
                coin["market_cap_rank"] if "market_cap_rank" in coin else None
            )
            fully_diluted_valuation = (
                coin["fully_diluted_valuation"]
                if "fully_diluted_valuation" in coin
                else None
            )
            ...
            price_change_24h = (
                coin["price_change_24h"] if "price_change_24h" in coin else None
            )
            ...
            market_cap_change_24h = (
                ...
                if "market_cap_change_24h" in coin
                else None
            )
            market_cap_change_percentage_24h = (
                coin["market_cap_change_percentage_24h"]
                if "market_cap_change_percentage_24h" in coin
                else None
            )
            circulating_supply = (
                coin["circulating_supply"] if "circulating_supply" in coin else None
            )
            ...
            ath_change_percentage = (
                ...
                if "ath_change_percentage" in coin
                else None
            )
            ...
            atl_change_percentage = (
                ...
                if "atl_change_percentage" in coin
                else None
            )
            ...
            crypto_obj.market_cap_change_percentage_24h = (
                market_cap_change_percentage_24h
            )
